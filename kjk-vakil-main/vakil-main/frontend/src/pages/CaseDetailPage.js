...
const CaseDetailPage = () => {
  ...
  // Fetch base case from my-cases list
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-slate-100">
      ...
      <div className="max-w-4xl mx-auto px-4 py-8">
        ...
        <button
          ...
          className="flex items-center gap-2 text-sm text-slate-500 hover:text-slate-800 mb-6 transition-colors group"
        >
        ...
        <motion.div
          ...
          className={`rounded-3xl overflow-hidden shadow-lg mb-6 ${justUpdated ? 'ring-2 ring-amber-400' : ''}`}
        >
          {/* Gradient header */}
          <div className={`bg-gradient-to-r ${currentColors.bar} to-slate-800 px-6 pt-6 pb-10`}>
            <AnimatePresence>
              {justUpdated && (
                <motion.div
